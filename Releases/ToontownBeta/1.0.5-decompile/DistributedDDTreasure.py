...
# File: DistributedDDTreasure.pyo (Python 2.0)
...
class DistributedDDTreasure(DistributedTreasure.DistributedTreasure):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedDDTreasure')
    
    def __init__(self, cr):
        DistributedTreasure.DistributedTreasure.__init__(self, cr)
        self.av = None
        self.treasureFlyMultiTrack = None
        return None
