...
# File: PointLight.pyo (Python 2.0)
...
def generateClass_PointLight():
    ...
    class PointLight(Light.Light, NamedNode.NamedNode, FFIExternalObject.FFIExternalObject):
        ...
        def overloaded_constructor_atomicstring(self, name):
            self.this = libpanda._inPi0oLWsGa(name)
            self.userManagesMemory = 1

        
        def overloaded_constructor(self):
            self.this = libpanda._inPi0oL5SP7()
            self.userManagesMemory = 1
        ...
        def destructor(self):
            if libpanda and libpanda._inPi0oL5UD2:
                libpanda._inPi0oL5UD2(self.this)
            

        
        def getClassType():
            returnValue = libpanda._inPi0oLVv_e()
        ...
        def getSpecular(self):
            returnValue = libpanda._inPi0oLUlme(self.this)
        ...
        def setSpecular(self, color):
            returnValue = libpanda._inPi0oLc_gr(self.this, color.this)
            return returnValue

        
        def getConstantAttenuation(self):
            returnValue = libpanda._inPi0oLpVof(self.this)
            return returnValue

        
        def setConstantAttenuation(self, att):
            returnValue = libpanda._inPi0oLW9c_(self.this, att)
            return returnValue

        
        def getLinearAttenuation(self):
            returnValue = libpanda._inPi0oL7Olm(self.this)
            return returnValue

        
        def setLinearAttenuation(self, att):
            returnValue = libpanda._inPi0oLatVt(self.this, att)
            return returnValue

        
        def getQuadraticAttenuation(self):
            returnValue = libpanda._inPi0oLz28m(self.this)
            return returnValue

        
        def setQuadraticAttenuation(self, att):
            returnValue = libpanda._inPi0oLFQlB(self.this, att)
            return returnValue

        
        def upcastToNamedNode(self):
            returnValue = libpanda._inPi0oL3wX0(self.this)
