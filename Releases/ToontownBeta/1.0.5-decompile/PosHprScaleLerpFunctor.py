...
# File: PosHprScaleLerpFunctor.pyo (Python 2.0)
...
def generateClass_PosHprScaleLerpFunctor():
    global classDefined
    if classDefined:
        return None
    ...
    class PosHprScaleLerpFunctor(LerpFunctor.LerpFunctor, FFIExternalObject.FFIExternalObject):
        ...
        def overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(self, np, pstart, pend, hstart, hend, sstart, send):
            self.this = libpanda._inPbPIPISSJ(np.this, pstart.this, pend.this, hstart.this, hend.this, sstart.this, send.this)
            self.userManagesMemory = 1

        
        def overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float(self, np, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez):
            self.this = libpanda._inPbPIPnMxs(np.this, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez)
            self.userManagesMemory = 1

        
        def overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(self, np, pstart, pend, hstart, hend, sstart, send, wrt):
            self.this = libpanda._inPbPIPmrMm(np.this, pstart.this, pend.this, hstart.this, hend.this, sstart.this, send.this, wrt.this)
            self.userManagesMemory = 1

        
        def overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_ptrNodePath(self, np, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez, wrt):
            self.this = libpanda._inPbPIPIfig(np.this, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez, wrt.this)
            self.userManagesMemory = 1
        ...
        def getClassType():
            returnValue = libpanda._inPbPIPug7x()
        ...
        def takeShortest(self):
            returnValue = libpanda._inPbPIP1EAV(self.this)
            return returnValue

        
        def takeLongest(self):
            returnValue = libpanda._inPbPIP_5ah(self.this)
            return returnValue
                                ...
                                if isinstance(_args[4], VBase3.VBase3):
                                    if isinstance(_args[5], VBase3.VBase3):
                                        if isinstance(_args[6], VBase3.VBase3):
                                            return self.overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6])
                                        else:
                                    ...
                                    if isinstance(_args[5], VBase3.VBase3):
                                        if isinstance(_args[6], VBase3.VBase3):
                                            if isinstance(_args[7], NodePath.NodePath):
                                                return self.overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7])
                                            else:
    ...
    globals()['PosHprScaleLerpFunctor'] = PosHprScaleLerpFunctor
