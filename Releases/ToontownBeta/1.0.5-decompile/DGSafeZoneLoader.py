...
# File: DGSafeZoneLoader.pyo (Python 2.0)
...
class DGSafeZoneLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def unload(self):
        ...
        base.unloadSfx(self.bird1Sound)
        del self.bird1Sound
        base.unloadSfx(self.bird2Sound)
        del self.bird2Sound
        base.unloadSfx(self.bird3Sound)
        del self.bird3Sound
        base.unloadSfx(self.bird4Sound)
        del self.bird4Sound
