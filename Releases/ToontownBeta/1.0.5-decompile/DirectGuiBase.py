...
# File: DirectGuiBase.pyo (Python 2.0)
...
class DirectGuiBase(PandaObject.PandaObject):
    ...
    def hascomponent(self, component):
        return component in self._DirectGuiBase__componentInfo.keys()
...
class DirectGuiWidget(DirectGuiBase, NodePath):
    ...
    def __init__(self, parent = guiTop, **kw):
        optiondefs = (('pgFunc', PGItem, None), ('numStates', 1, None), ('invertedFrames', (), None), ('sortOrder', 0, None), ('state', NORMAL, self.setState), ('relief', FLAT, self.setRelief), ('borderWidth', (0.1, 0.1), self.setBorderWidth), ('frameSize', None, self.setFrameSize), ('frameColor', (0.8, 0.8, 0.8, 1), self.setFrameColor), ('pad', (0, 0), self.resetFrameSize), ('guiId', None, INITOPT), ('pos', None, INITOPT), ('scale', None, INITOPT), ('color', None, INITOPT))
