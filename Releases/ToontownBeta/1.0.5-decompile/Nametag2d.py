...
def generateClass_Nametag2d():
    ...
    class Nametag2d(Nametag.Nametag, MarginPopup.MarginPopup, FFIExternalObject.FFIExternalObject):
        ...
        def destructor(self):
            if libtoontown and libtoontown._inPPj7bey5G:
                libtoontown._inPPj7bey5G(self.this)
            

        
        def getClassType():
            returnValue = libtoontown._inPPj7bdOel()
        ...
        def upcastToMarginPopup(self):
            returnValue = libtoontown._inPPj7b0GmQ(self.this)
        ...
        def isManaged(self):
            ...
            returnValue = libtoontown._inPPj7bq0fn(upcastSelf.this)
            return returnValue
        ...
        def isVisible(self):
            upcastSelf = self
            upcastSelf = upcastSelf.upcastToMarginPopup()
            returnValue = libtoontown._inPPj7bHRhT(upcastSelf.this)
            return returnValue
