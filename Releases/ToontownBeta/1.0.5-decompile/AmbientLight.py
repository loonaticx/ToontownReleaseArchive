...
# File: AmbientLight.pyo (Python 2.0)
...
def generateClass_AmbientLight():
    global classDefined
    if classDefined:
        return None
    ...
    class AmbientLight(Light.Light, NamedNode.NamedNode, FFIExternalObject.FFIExternalObject):
        ...
        def overloaded_constructor_atomicstring(self, name):
            self.this = libpanda._inPi0oLyCLD(name)
            self.userManagesMemory = 1

        
        def overloaded_constructor(self):
            self.this = libpanda._inPi0oLpeTx()
            self.userManagesMemory = 1
        ...
        def destructor(self):
            if libpanda and libpanda._inPi0oLdq5S:
                libpanda._inPi0oLdq5S(self.this)
            

        
        def getClassType():
            returnValue = libpanda._inPi0oLYYoS()
        ...
        def upcastToNamedNode(self):
            returnValue = libpanda._inPi0oLCMwV(self.this)
