...
# File: ScaleLerpFunctor.pyo (Python 2.0)
...
def generateClass_ScaleLerpFunctor():
    global classDefined
    if classDefined:
        return None
    ...
    class ScaleLerpFunctor(SimpleLerpFunctorLVecBase3f.SimpleLerpFunctorLVecBase3f, FFIExternalObject.FFIExternalObject):
        ...
        def getClassType():
            returnValue = libpanda._inPbPIP33cM()
    ...
    globals()['ScaleLerpFunctor'] = ScaleLerpFunctor
