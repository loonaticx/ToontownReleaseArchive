...
# File: ColorLerpFunctor.pyo (Python 2.0)
...
def generateClass_ColorLerpFunctor():
    global classDefined
    if classDefined:
        return None
    ...
    class ColorLerpFunctor(SimpleLerpFunctorLVecBase4f.SimpleLerpFunctorLVecBase4f, FFIExternalObject.FFIExternalObject):
        ...
        def overloaded_constructor_ptrNodePath_ptrLVecBase4f_ptrLVecBase4f(self, np, start, end):
            self.this = libpanda._inPbPIP9lQr(np.this, start.this, end.this)
        ...
        def overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float(self, np, sr, sg, sb, sa, er, eg, eb, ea):
            self.this = libpanda._inPbPIPgaHg(np.this, sr, sg, sb, sa, er, eg, eb, ea)
            self.userManagesMemory = 1

        
        def overloaded_constructor_ptrNodePath_ptrLVecBase4f_ptrLVecBase4f_ptrNodePath(self, np, start, end, wrt):
            self.this = libpanda._inPbPIPNFWf(np.this, start.this, end.this, wrt.this)
            self.userManagesMemory = 1
        ...
        def overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_ptrNodePath(self, np, sr, sg, sb, sa, er, eg, eb, ea, wrt):
            self.this = libpanda._inPbPIP5kC9(np.this, sr, sg, sb, sa, er, eg, eb, ea, wrt.this)
            self.userManagesMemory = 1
        ...
        def getClassType():
            returnValue = libpanda._inPbPIPn76o()
    ...
    globals()['ColorLerpFunctor'] = ColorLerpFunctor
